    ...
    emailjs
      .send(
        ...
        "template_hv411uf",
        {
          ...
          to_email: "mynameizkus@gmail.com",
        ...
        >
          <label className="flex flex-col">
            ...
            <input
              ...
              className="mt-2 bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium"
            ></input>
          </label>
          <label className="flex flex-col">
